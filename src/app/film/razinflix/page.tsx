...
export default function RazinFlixPage() {
    ...
    return (
        <div className="min-h-screen bg-[#141414] text-white pb-20 font-sans">
            {/* Navbar - Logo Removed */}
            <nav className={`fixed top-0 w-full z-40 transition-colors duration-300 px-4 md:px-12 py-4 flex items-center justify-end ${scrolled ? 'bg-[#141414]' : 'bg-gradient-to-b from-black/80 to-transparent'}`}>
            ...
            {!searchTerm && (
                <div className="relative h-[70vh] w-full bg-black flex items-center justify-center overflow-hidden">
