...
import type { TahoeGlassContentTone } from '@/components/ui/tahoe-glass'

interface WalletLoginProps {
    tone?: TahoeGlassContentTone
}

export default function WalletLogin({ tone = 'light' }: WalletLoginProps) {
    ...
    return (
        <div className="space-y-3">
            <p className={`text-center text-[11px] px-4 leading-tight mb-2 ${tone === 'dark' ? 'text-slate-950/80' : 'text-white/70'}`}>
            ...
            >
                <span className="relative z-10 flex items-center gap-2">
                    ...
                    <svg width="20" height="20" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-80">
                        <path d="M15.925 23.96L16 24.075L16.08 23.96L23.515 13.56L16 0L8.485 13.56L15.925 23.96ZM16.08 25.12L16 25.005L15.925 25.12L8.485 14.72L16 32L23.515 14.72L16.08 25.12Z" fill="currentColor" />
                    </svg>
            ...
            >
                <span className="relative z-10 flex items-center gap-2">
                    ...
                    <svg width="20" height="20" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-80">
                        ...
                        <path d="M26.96 6.80005L26.34 7.50005C26.16 7.70005 25.76 7.70005 25.56 7.50005L21.36 4.60005H5.80005L8.74005 7.60005H21.34L26.96 6.80005ZM26.2 11.2H13.6L10.66 8.20005H26.2V11.2ZM5.80005 17.8H21.36L25.56 14.9C25.76 14.7 26.16 14.7 26.34 14.9L26.96 15.6L21.34 14.8H8.74005L5.80005 17.8Z" fill="currentColor" />
                    </svg>
